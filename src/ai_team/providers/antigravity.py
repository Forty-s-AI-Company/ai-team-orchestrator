...
def _compact_prompt(
    ...
    if autonomous_discovery:
        normalized = (
            ...
            "Use changePolicy={schemaChanges:false,apiContractChanges:false,migrationArtifacts:false,fixtureData:false}; "
            "all values must be booleans, never string/array/null. "
