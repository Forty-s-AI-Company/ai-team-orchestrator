...
def write_run_receipt(
    ...
    payload: dict[str, Any] = {
        ...
        "role": result.provider_result.data.get("role"),
        "routingProfile": result.provider_result.data.get("routingProfile"),
        "selectedProvider": result.provider_result.data.get("selectedProvider"),
        "selectedModel": result.provider_result.data.get("selectedModel"),
        "reasoningEffort": result.provider_result.data.get("reasoningEffort"),
        "primaryRoute": redact_secrets(result.provider_result.data.get("primaryRoute")),
        "fallbackUsed": result.provider_result.data.get("fallbackUsed", False),
        "fallbackChain": redact_secrets(result.provider_result.data.get("fallbackChain", [])),
        "secondaryReview": redact_secrets(result.provider_result.data.get("secondaryReview")),
        ...
        "tokenUsageReported": result.provider_result.data.get(
            "tokenUsageReported",
            "tokenUsage" in result.provider_result.data,
        ),
